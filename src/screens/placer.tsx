...
export default function AMEStatus() {
  ...
  const downloadTemplate = async () => {
    try {
      ...
      // Create headers array without styling first
      const headers = [
        'S.No',
        'IRLA No./Regt. ID',
        'Rank',
      ...
      for (let col = headerRange.s.c; col <= headerRange.e.c; col++) {
        ...
        // Apply bold and larger font size to headers
        ws[cellRef].s = {
          font: { 
            bold: true, 
            sz: 18 // Font size 14 for headers
          },
          alignment: { 
            horizontal: 'center',
            vertical: 'center'
          ...
          fill: {
            fgColor: { rgb: 'E6E6FA' } // Light background for headers
          }
        };
      }
      ...
      ws['!rows'] = [{ hpt: 25 }]; // Height for header row
      ...
      if (Platform.OS === 'web') {
        ...
        // Write as base64 for React Native
                ...
                <Card.Content>
                  ...
                  <View style={styles.tableFooter}>
                    <View style={styles.footerContent}>
                      <Icon name="information" size={16} color="#757575" />
                      <Text style={styles.footerText}>
                        Displaying {filteredRecords.length} of {ameRecords.length} AME records
                      </Text>
                    </View>
                  </View>
                </Card.Content>
